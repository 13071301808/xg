 ...
 * @desc: APP订阅页面曝光解析
 */
public class AppSubscribePageExposureProcess extends ProcessFunction<String, JSONObject> {

    static Logger logger = LoggerFactory.getLogger(AppSubscribePageExposureProcess.class);
    ...
    public void processElement(String value, Context ctx, Collector<JSONObject> out) throws Exception {
        ...
        try {
            ...
            if (EventParseUtil.isEvent(jsonText, "subscribepageexposure")) {
                ...
                if (scdata != null) {
                    ...
                    subscribePageExposureResult.put(ModelUtil.humpToUnderline("reportTime"), reportTime);
                    ...
                    if (supplierArr != null) {
                        ...
                        for (Object supplierObject : supplierArr) {
                            ...
                            if (supplierJson != null) {
                                ...
                                String bannerId = supplierJson.getString("banner_id");
                                String bannerName = supplierJson.getString("banner_name");
                                ...
                                subscribePageExposureResult.put(ModelUtil.humpToUnderline("bannerId"), bannerId);
                                subscribePageExposureResult.put(ModelUtil.humpToUnderline("bannerName"), bannerName);

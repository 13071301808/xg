...
public class LunarCalendar implements Serializable {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            String lunarYear = lunar.getLyear() + "";
            String lunarMonth = lunar.getLmonth() + "";
            if (lunarMonth.length() == 1) {
                lunarMonth = "0" + lunarMonth;
            }
            String lunarDay = lunar.getLdate() + "";
            if (lunarDay.length() == 1) {
                lunarDay = "0" + lunarDay;
            }
            String isLeap = lunar.isLeapMonth() ? "润" : "";

            System.out.println(currentDate + "\t" + lunarYear + lunarMonth + lunarDay + isLeap);

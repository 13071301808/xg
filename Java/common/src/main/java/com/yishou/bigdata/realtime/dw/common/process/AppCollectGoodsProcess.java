...
public class AppCollectGoodsProcess extends ProcessFunction<String, JSONObject> {
    static Logger logger = LoggerFactory.getLogger(AppCollectGoodsProcess.class);
    ...
    public void processElement(String value, Context context, Collector<JSONObject> collector) throws Exception {
        try {
            ...
            if (EventParseUtil.isEvent(data, "goodcollect")) {
                ...
                goodsCollectResult.put("dt", DateUtil.secondToSpecialDate(Long.parseLong(receiveTime)));
                goodsCollectResult.put("event_name", "dwd_goods_collect");
